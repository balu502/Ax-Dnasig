...
class DnaSig : public QObject
{
    ...
    bool checkTextInput(QLineEdit *ei);
...
public slots:
    ...
    bool    appendStream(QTextStream *textStrm,     bool applySign=false);
    bool    appendDomElement(QDomElement *docElem,  bool applySign=false);
